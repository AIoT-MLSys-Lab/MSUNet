...
def create_transform_CIFAR100(
    ...
    if tf_preprocessing and use_prefetcher:
        ...
        if is_training:
            transform = transforms_CIFAR100_train(
                img_size,
                color_jitter=color_jitter,
                auto_augment=auto_augment,
                interpolation=interpolation,
            ...
            transform = transforms_CIFAR100_eval(
                img_size,
                interpolation=interpolation,
                use_prefetcher=use_prefetcher,
                mean=mean,
...
def create_loader_CIFAR100(
    ...
    dataset.transform = create_transform_CIFAR100(
        input_size,
        is_training=is_training and not is_clean_data,
        use_prefetcher=use_prefetcher,
        color_jitter=color_jitter,
        auto_augment=auto_augment,
        interpolation=interpolation,
